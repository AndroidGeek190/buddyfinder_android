package com.erginus.buddyfinder.Intro;
...
//        next = ImageButton.class.cast(findViewById(R.id.next));
    ...
    private void buildCircles(){
        ...
        for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
            ...
            circle.setImageResource(R.drawable.find_friend);
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                if(i == index){
                    circle.setColorFilter(getResources().getColor(R.color.red));
                }else {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = Intro_fragments_Refresh.newInstance(R.layout.intro_ist);
                    break;
                case 1:
                    tp = Intro_fragments_Refresh.newInstance(R.layout.intro_2nd);
                    break;
                case 2:
                    tp = Intro_fragments_Refresh.newInstance(R.layout.intro_3rd);
                    break;
                case 3:
                    tp = Intro_fragments_Refresh.newInstance(R.layout.intro_4th);
                    break;
            }
